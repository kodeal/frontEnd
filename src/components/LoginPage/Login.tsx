...
const SigninButton = styled.button`
    ...
    border: 1px solid black;
`
const SignupButton: StyledComponent<React.ForwardRefExoticComponent<LinkProps & React.RefAttributes<HTMLAnchorElement>>, any, {}, never> = styled(Link)`
    display: block;
    font-size: 25px;
    width: 278px;
    font-weight: bold;
...
export default function Login(props: any) : JSX.Element{
    ...
    const login = async (e : any) => {
        e.preventDefault()
        const result : AxiosResponse<api.loginType, any>  = await api.login(id, pwd)
        console.log(result)
